...
```{r linear-regression-example, fig.align='center', warning=FALSE}
...
modelsummary(lm,
             ...
             output = "kableExtra") %>% 
  kable_styling(html_font = "Arial", bootstrap_options = c("condensed", "hover"), position = "center") %>% 
