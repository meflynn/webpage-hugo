...
ttest.tab %>% 
  ...
  kable_styling(html_font = "Arial", font_size = 6, position = "center")
...
```{r linear-regression-example, warning=FALSE, fig.align='center'}
...
modelsummary(lm,
             ...
             output = "kableExtra") %>% 
  kable_styling(html_font = "Arial", position = "center") %>% 
