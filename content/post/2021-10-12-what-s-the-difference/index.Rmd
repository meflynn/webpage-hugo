...
```{r t-test-example, layout="l-body-outset"}
...
ttest.tab <- ttest.tab %>% 
  kbl(digits = 2, fontsize = 7, caption = "Difference of means test of bipartisan voting", label = "t test example") %>% 
  kable_styling(html_font = "Arial", bootstrap_options = c("condensed", "hover", "responsive"), position = "center", full_width = TRUE)
...
modelsummary(lm,
             ...
             output = "kableExtra") %>% 
  kable_styling(html_font = "Arial", bootstrap_options = c("condensed", "hover")) %>% 
